...
import 'package:restoguh/data/datasources/report_remote_datasource.dart';
...
class CloseCashierBloc extends Bloc<CloseCashierEvent, CloseCashierState> {
  ...
  CloseCashierBloc(this.reportRemoteDatasource) : super(const _Initial()) {
    on<_CloseCashier>((event, emit) async {
      ...
      result.fold((l) => emit(CloseCashierState.error(l)), (r) {
