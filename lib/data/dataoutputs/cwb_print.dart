...
class CwbPrint {
  ...
  Future<List<int>> printOrderV2(
    ...
    bytes += generator.text(
      'Jl. Palagan Tentara Pelajar No.2',
      styles: const PosStyles(bold: false, align: PosAlign.center),
    );
    bytes += generator.text(
  ...
  Future<List<int>> printQRIS(int totalPrice, Uint8List imageQris) async {
    List<int> bytes = [];
